...
func (_m *Usecase) Create(ctx context.Context, domain redeem.Domain) (redeem.Domain, error) {
...
func (_m *Usecase) GetAll(ctx context.Context) ([]redeem.Domain, error) {
	ret := _m.Called(ctx)
...
func (_m *Usecase) GetById(ctx context.Context, id int) (redeem.Domain, error) {
	ret := _m.Called(ctx, id)
...
func (_m *Usecase) GetByItemId(ctx context.Context, id int) ([]redeem.Domain, error) {
	ret := _m.Called(ctx, id)
...
func (_m *Usecase) GetByUserId(ctx context.Context, id int) ([]redeem.Domain, error) {
	ret := _m.Called(ctx, id)
