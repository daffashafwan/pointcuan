...
func (_m *Usecase) Create(ctx context.Context, domain categoryItems.Domain) (categoryItems.Domain, error) {
...
func (_m *Usecase) GetAll(ctx context.Context) ([]categoryItems.Domain, error) {
	ret := _m.Called(ctx)
...
func (_m *Usecase) GetById(ctx context.Context, id int) (categoryItems.Domain, error) {
	ret := _m.Called(ctx, id)
...
func (_m *Usecase) Update(ctx context.Context, domain categoryItems.Domain, id int) (categoryItems.Domain, error) {
	ret := _m.Called(ctx, domain, id)

	var r0 categoryItems.Domain
	if rf, ok := ret.Get(0).(func(context.Context, categoryItems.Domain, int) categoryItems.Domain); ok {
		r0 = rf(ctx, domain, id)
	} else {
		r0 = ret.Get(0).(categoryItems.Domain)
	}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, categoryItems.Domain, int) error); ok {
		r1 = rf(ctx, domain, id)
	} else {
		r1 = ret.Error(1)
	}
